...
def bench(num_sequences: int,
    ...
    return Results(num_sequences=num_sequences,
...
def main(config: Config):
    experiments = OrderedDict(num_sequences=config.num_sequences,

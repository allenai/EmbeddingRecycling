...
class CustomBERTModel(nn.Module):
    ...
    def forward(self, ids, mask):
	    ...
	    if switch_to_embeddings == False:
	          ...
	          total_output = self.encoderModel.encoder(savedEmbeddings)
...
for dataset in classification_datasets:
    ...
    for i in range(0, number_of_runs):
        ...
        for epoch in range(num_epochs):
            ...
            for batch in train_dataloader:
                ...
                with torch.no_grad():
                	...
                	if count == 0:
	                    ...
	                    count += 1
	                    savedEmbeddings = embeddings
	                    saved_labels = labels
	                    print("Loss of first batch")
	                    print(loss)
            ...
            test_loss = criterion(outputs, saved_labels)

            print("Loss of embeddings")
            print(test_loss)
